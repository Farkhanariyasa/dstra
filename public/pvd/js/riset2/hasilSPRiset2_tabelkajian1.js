...
for (let i = 1; i < 5; i++) {
  $(document).ready(function () {
    var table = $("#k1_tabel" + [i]).DataTable({
      language: {
    ...
    const element = document.querySelector("#k1_tabel"+[i]+"_wrapper");
    element.insertBefore(div, element.childNodes[1]);
    table.buttons().container().appendTo("#k1_tabel"+[i]+"_wrapper .col-md-12:eq(0)");
  });
  idinput = i - 1;
}
...
//   div.classList.add("my-3");
//   div.appendChild(baris);
//   const element = document.querySelector("#k1_tabel1_wrapper");
//   element.insertBefore(div, element.childNodes[1]);
//   table.buttons().container().appendTo("#k1_tabel1_wrapper .col-md-12:eq(0)");
// });

// Tabel 2
// $(document).ready(function () {
//   var table = $("#k1_tabel2").DataTable({
//     language: {
//       emptyTable: "Tidak ada data yang tersedia pada tabel ini",
//       info: "Menampilkan _START_ sampai _END_ dari _TOTAL_ entri",
//       infoEmpty: "Menampilkan 0 sampai 0 dari 0 entri",
...
//   div.classList.add("my-3");
//   div.appendChild(baris);
//   const element = document.querySelector("#k1_tabel2_wrapper");
//   element.insertBefore(div, element.childNodes[1]);
//   table.buttons().container().appendTo("#k1_tabel2_wrapper .col-md-12:eq(0)");
// });

// Tabel 3
// $(document).ready(function () {
//   var table = $("#k1_tabel3").DataTable({
//     language: {
//       emptyTable: "Tidak ada data yang tersedia pada tabel ini",
//       info: "Menampilkan _START_ sampai _END_ dari _TOTAL_ entri",
//       infoEmpty: "Menampilkan 0 sampai 0 dari 0 entri",
...
//   div.classList.add("my-3");
//   div.appendChild(baris);
//   const element = document.querySelector("#k1_tabel3_wrapper");
//   element.insertBefore(div, element.childNodes[1]);
//   table.buttons().container().appendTo("#k1_tabel3_wrapper .col-md-12:eq(0)");
// });
