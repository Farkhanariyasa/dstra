...
const batang = new Chart(riset1_hasil1, {
  type: "doughnut",
  data: {
    labels: ["Jumlah Anggota 0", "Jumlah Anggota 1", "Jumlah Anggota 2", "Jumlah Anggota 3", "Jumlah Anggota 4", "Jumlah Anggota 5"],

    datasets: [
      {
        label: "Jumlah Anggota",
        data: [jumlahanggota.ja0, jumlahanggota.ja1, jumlahanggota.ja2, jumlahanggota.ja3, jumlahanggota.ja4, jumlahanggota.ja5],
        borderwidth: 1,
        backgroundColor: ["#ffab00", "#ffbc33", "#ffdd99", "#ffeecc", "#506396", "#c27d90"],
      },
    ],
  },
  options: {
...
function tampilData() {
  if (barchart.value == "b") {
    ...
    batang.data.datasets[0].data = [jeniskelamin.laki, jeniskelamin.perempuan];
