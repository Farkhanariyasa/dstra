let delayed_fg_output6;
const fg_output6 = document.getElementById("fg_output6");
const bubble_fg_output6 = new Chart(fg_output6, {
  type: "bubble",
  data: {
  ...
  options: {
    ...
    animation: {
      onComplete: () => {
        delayed_fg_output6 = true;
      },
      delay: (context) => {
        let delay = 0;
        if (context.type === "data" && context.mode === "default" && !delayed_fg_output6) {
