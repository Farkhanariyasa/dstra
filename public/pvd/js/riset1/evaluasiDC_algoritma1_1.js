let delayed_dc_algoritma1_1;
const dc_algoritma1_1 = document.getElementById("dc_algoritma1_1");
const bar_dc_algoritma1_1 = new Chart(dc_algoritma1_1, {
  type: "bar",
  data: {
  ...
  options: {
    ...
    animation: {
      onComplete: () => {
        delayed_dc_algoritma1_1 = true;
      },
      delay: (context) => {
        let delay = 0;
        if (context.type === "data" && context.mode === "default" && !delayed_dc_algoritma1_1) {
