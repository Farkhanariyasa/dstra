<!-- Double Counting -->
<div class="modal fade" id="exampleModaldc" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Family Grouping -->
<!-- 1 -->
<div class="modal fade" id="exampleModalfg1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
...
<!-- 2 -->
<div class="modal fade" id="exampleModalfg2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
            ...
            <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset1/unduh" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button type="submit" id="btndownload3" class="tombolkonf" data-bs-dismiss="modal">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
...
<!-- Wisnus -->
<div class="modal fade" id="exampleModalwisnus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
