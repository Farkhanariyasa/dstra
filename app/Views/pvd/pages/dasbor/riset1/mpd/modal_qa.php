<?php for ($i = 1; $i < 39; $i++) : ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset1/mpd-qualityassurance" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button disabled type="submit" id="qa<?php echo $i ?>" class="tombolkonf" data-bs-dismiss="modal" aria-label="Close">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
