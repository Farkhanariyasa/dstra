    ...
    <div class="modal fade" id="exampleModal<?php echo $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset1/mpd-familygrouping" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="fg<?php echo $i ?>" class="tombolkonf" data-bs-dismiss="modal" aria-label="Close">Konfirmasi</button>
                    </div>
                </form>
            </div>
        </div>
