<?php for ($i = 1; $i <= 4; $i++) : ?>
    ...
    <div class="modal fade" id="ModalLp_<?php echo $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset3_landing_page/unduh" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btndownloadLp_<?php echo $i ?>" class="tombolkonf">Konfirmasi</button>
                    </div>
                </form>
            </div>
        </div>
