    ...
    <div class="modal fade" id="Modal1_<?php echo $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset3/unduhtujuan1" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button disabled type="submit" id="btndownload1_<?php echo $i ?>" class="tombolkonf">Konfirmasi</button>
                    </div>
                </form>
            </div>
        </div>
