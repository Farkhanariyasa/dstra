<?php for ($i = 1; $i <= 1; $i++) : ?>
    <div class="modal fade" id="Modal4_<?php echo $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset3/hasilkajian4" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button disabled type="submit" id="btndownload4_<?php echo $i ?>" class="tombolkonf">Konfirmasi</button>
                    </div>
                </form>
            </div>
        </div>
