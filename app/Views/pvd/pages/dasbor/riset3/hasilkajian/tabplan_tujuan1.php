            ...
            <table class="table table-hover table-bordered table-responsive display" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">
                            <= 19 m^2</th>
                        <th scope="col">20-49 m^2</th>
                        <th scope="col">50-99 m^2</th>
                        <th scope="col">100-149 m^2</th>
                        <th scope="col">>= 150 m^2</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive border rounded" style="padding: 0.5rem 1rem;">
            <table class="table table-hover table-bordered table-responsive display" style="width:100%">
                <thead>
                    <tr>
                        <th scope="col">Tingkat Pendidikan KRT</th>
                        <th scope="col">Memiliki rumah lain selain tempat tinggal saat ini</th>
                        <th scope="col">Tidak memiliki rumah lain selain tempat tinggal saat ini</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table class="table table-hover table-bordered table-responsive display" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Genteng</th>
                        <th scope="col">Seng</th>
                        <th scope="col">Asbes</th>
                        <th scope="col">Bambu</th>
                        <th scope="col">Kayu/Sirap</th>
                        <th scope="col">Lainnya</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table class="table table-hover table-bordered table-responsive display" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Plesteran anyaman bambu/kawat</th>
                        <th scope="col">Kayu/Papan</th>
                        <th scope="col">Anyaman Bambu</th>
                        <th scope="col">Bambu</th>
                        <th scope="col">Lainnya</th>
                    </tr>
                </thead>
        ...
        <div class="card-body table-responsive border rounded" style="padding: 0.5rem 1rem;">
            <table class="table table-hover table-bordered table-responsive display" style="width:100%">
                <thead>
                    <tr>
                        <th scope="col">Jenis Industri Pariwisata</th>
                        <th scope="col">Marmer/granit</th>
                        <th scope="col">Keramik</th>
                        <th scope="col">Parket/vinil/karpet</th>
                        <th scope="col">Ubin/tegel/teraso</th>
                        <th scope="col">Semen/bata merah</th>
            ...
            <table class="table table-hover table-bordered table-responsive display" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Tidak ada fasilitas</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
