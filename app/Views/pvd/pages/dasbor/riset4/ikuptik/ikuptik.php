...
<div class="col-sm-4 my-2">
        <div class="card shadow rounded-4" style="height: 350px;">
            ...
            <div class="card-body">
                ...
                Indeks kesiapan unit usaha pariwisata dalam pemanfaatan TIK atau yang biasa disingkat <b>IKUPTIK</b> merupakan hasil rata-rata geometris dari nilai indeks pada keenam dimensi yang diukur pada seluruh unit usaha yang ada di Kota Batu.
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow rounded-4">
                <div class="card-body">
                    ...
                    <div style=" height:300px;">
                        <canvas class="mt1" id="vis-1"></canvas>
                    </div>
