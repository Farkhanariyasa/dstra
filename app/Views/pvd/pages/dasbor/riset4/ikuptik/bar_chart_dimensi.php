<!-- Dodge Bar Chart Menu IKUPTIK submenu Dimensi per Kecamatan (Kiri)-->
...
<!-- Dodge Bar Chart Menu IKUPTIK submenu Dimensi per Jenis Unit Usaha (Kanan) -->
<!-- <div class="portfolio-item filter-riset4-hasil1">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="position-absolute bot-0  end-0 d-flex flex-row justify-content-center align-item-center ">
                        <div class="form-check form-switch me-3">
                            <input class="form-check-input" onchange="update_value(this);" type="checkbox" id="barChartLegend" value="show" checked>
                            <label class="form-check-label" style="margin-left:-3px;" for="flexSwitchCheckChecked">Tampilkan Legenda</label>
                        </div>
                    </div>
                </div>
...
<!-- <div class="portfolio-item filter-riset4-fg" onresize="responsivefonts()">
    <div class="row mt-3">
