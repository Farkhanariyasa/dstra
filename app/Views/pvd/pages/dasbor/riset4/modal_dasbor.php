    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="unduhVisualisasi" action="<?= base_url('hasil-pkl/riset4/dasbor'); ?>" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button disabled type="submit" id="button-download-4" class="tombolkonf" data-bs-dismiss="modal" aria-label="Close">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="unduhVisualisasi" action="<?= base_url('hasil-pkl/riset4/dasbor'); ?>" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button disabled type="submit" id="button-download-6" class="tombolkonf" data-bs-dismiss="modal" aria-label="Close">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="unduhVisualisasi" action="<?= base_url('hasil-pkl/riset4/dasbor'); ?>" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button disabled type="submit" id="button-download-8" class="tombolkonf" data-bs-dismiss="modal" aria-label="Close">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="unduhVisualisasi" action="<?= base_url('hasil-pkl/riset4/dasbor'); ?>" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button disabled type="submit" id="button-download-10" class="tombolkonf" data-bs-dismiss="modal" aria-label="Close">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
