<!-- 1 -->
<div class="modal fade" id="exampleModal_t1_hasil1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- 2 -->
<div class="modal fade" id="exampleModal_t1_hasil2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
...
<!-- 3 -->
<!-- <div class="modal fade" id="exampleModal_t1sankey" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
            ...
            <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset2/unduh" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button type="submit" id="btndownload1" class="tombolkonf"
...
<!-- 4 -->
<!-- <div class="modal fade" id="exampleModal_t1map2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
            ...
            <form name="unduhVisualisasi" action="<?= base_url(); ?>/hasil-pkl/riset2/unduh" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="tombol btn-danger" data-bs-dismiss="modal">Kembali</button>
                    <button type="submit" id="btndownload2" class="tombolkonf"
                        data-bs-dismiss="modal">Konfirmasi</button>
                </div>
            </form>
        </div>
...
<!-- 5 -->
<!-- <div class="modal fade" id="exampleModal_t1pie" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
...
<!-- 6 -->
<!-- <div class="modal fade" id="exampleModal_t1twowaybar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
