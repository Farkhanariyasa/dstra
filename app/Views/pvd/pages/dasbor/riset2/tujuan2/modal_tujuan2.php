<!-- 1 -->
<div class="modal fade" id="exampleModal_t2_hasil1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- 2 -->
<div class="modal fade" id="exampleModal_t2_hasil2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Unduh Hasil PKL</h4>
