    ...
    <div class="container mt-5">
        <div class="card d-flex justify-content-center flex-column align-item-center flex-md primary pb-5 pt-5 shadow">
            <p class="card-text text-center">
                <strong>Sebaran Wisatawan dalam Kota Malang menurut Kecamatan Asal Wisatawan di Kota Malang Bulan Oktober-Desember 2022</strong>
            </p>
                ...
                <div class="card-body">
                    ...
                    <div class="position-absolute bot-0  end-0 d-flex flex-row justify-content-center align-item-center ">
                        <div class="form-check form-switch me-3">
                            <input class="form-check-input" onchange="update_value(this);" type="checkbox" id="forPieChartLegend" value="show">
