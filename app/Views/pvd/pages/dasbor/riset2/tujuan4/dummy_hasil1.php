...
<div class="portfolio-item filter-riset2-hasil1">
    ...
    <div class="row mt-3 tujuan4hasil1">
...
<div class="portfolio-item filter-riset2-hasil1">
    <div class="col-12 col-sm-12">
        <h1 class="headline text-center">Kerangka Pikir</h1>
    </div>

    <div class="row mt-3">
        <div class="col-lg-12 grid-margin stretch-card">
            <img src="<?= base_url('pvd/img/dasbor/riset2/kerangka_pikir.png') ?>" class="img-fluid m-auto p-auto" alt="" style="width: auto;">
...
<div class="portfolio-item filter-riset2-hasil1">
    ...
    <div class="row interpretasi tujuan4hasil1">
        <div class="col interpretasi">
            ...
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-3 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_4.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto;">
                    </div>
                    <div class="text-center" style="color: #4b395f; font-size: 25px;"><strong>Jenis Kelamin</strong>
                    </div>
                    <div class="row row-cols-2 mt-2" style="color: #4b395f; font-size:25px; ">
            ...
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-4 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_9.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto">
                    </div>
        ...
        <div class="col interpretasi">
            ...
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-3 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_5.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto">
                    </div>
                    ...
                    <div class="row row-cols-2 mt-2" style="color: #4b395f; font-size:25px;">
                        ...
                        <div class="col-lg-10 grid-margin text-start pl-0" style="font-size:15px; margin-left: -1rem;">
                            Penduduk tamatan SMP dan penduduk yang tidak/belum sekolah/tidak tamat SD/MI cenderung memiliki peluang yang sama untuk memutuskan melakukan perjalanan wisata.
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-2 mt-2" style="color: #4b395f; font-size:25px;">
                        ...
                        <div class="col-lg-10 grid-margin text-start pl-0" style="font-size:15px; margin-left: -1rem;">
                            Penduduk tamatan SMA dan penduduk yang tidak/belum sekolah/tidak tamat SD/MI cenderung memiliki peluang yang sama untuk memutuskan melakukan perjalanan wisata.
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-2 mt-2" style="color: #4b395f; font-size:25px;">
                        ...
                        <div class="col-lg-10 grid-margin text-start pl-0" style="font-size:15px; margin-left: -1rem;">
                            Penduduk tamatan Perguruan Tinggi dan penduduk yang tidak/belum sekolah/tidak tamat SD/MI cenderung memiliki peluang yang sama untuk memutuskan melakukan perjalanan wisata.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row tujuan4hasil1">
        <div class="col interpretasi">
            <!-- Jenis Pekerjaan KRT -->
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-3 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_6.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto">
                    </div>
        ...
        <div class="col interpretasi">
            ...
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-3 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_13.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto">
                    </div>
    ...
    <div class="row tujuan4hasil1">
        <div class="col interpretasi">
            ...
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-3 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_7.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto">
                    </div>
        ...
        <div class="col interpretasi">
            ...
            <div class="card konten2 third5 par mx-auto mb-3 p-1 p-md-1 shadow box rounded-5 mt-3 align-items-center d-flex flex-column">
                <div class="card-body text-center">
                    <div class="row-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('pvd/img/dasbor/riset2/artboard_8.png') ?>" class="img-fluid" alt="" style="height: 75px; width:auto">
                    </div>
