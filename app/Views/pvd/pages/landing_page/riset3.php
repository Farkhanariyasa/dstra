            ...
            <div class="col-lg-7 d-flex flex-column justify-content-center">
                ...
                <div data-aos="fade-up" data-aos-delay="600">
                    <div class="text-center text-lg-start">
                        <a href="<?= base_url('pvd/riset3/dasbor') ?>" class="tombol btn-for">>
                            <span>Hasil PKL</span>
            ...
            <div class="fourth">
                <div class="row align-items-center">
                    <div class="col-md-1 text-center mt-2" data-aos="zoom-in" data-aos-duration="1000">
                        <!-- <img class="chart img-fluid" src="<?= base_url("Assets/Img/LogoPKL.png") ?>" alt="Nothing "> -->
                    </div>
                </div>
            </div>
...
<!-- <script>
  ...
  new Chart(ctx, {
    type: 'bar',
    data: {
      labels: ['Red', 'red', 'Yellow', 'Green', 'Purple', 'Orange', 'Orange', 'Orange'],
      datasets: [{
        label: '# of Votes',
