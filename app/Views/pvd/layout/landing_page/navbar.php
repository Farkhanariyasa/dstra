	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav nav ml-auto mt-2" style="background:transparent !important">
				...
				<li class="nav-item"><a href="<?= base_url("hasil-pkl/riset4") ?>" class="nav-link nav-menu text-center <?= $request->uri->getSegment(2) == "riset4" ? "active" : "" ?>"data-bs-toggle="tooltip" title="Kesiapan Pemanfaatan TIK Unit Usaha Pariwisata Skala Mikro dan Kecil di Kota Batu dalam Menerapkan Smart Tourism Destination" ><span>Riset 4</span></a></li>
			</ul>
		</div>
	</div>
</nav>
