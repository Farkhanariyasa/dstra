...
$routes->group('hasil-pkl', ['namespace' => 'App\Controllers\Pvd'], function ($routes) {
    ...
    $routes->group('riset4', ['namespace' => 'App\Controllers\Pvd\Dasbor'], function ($routes) {
        ...
        $routes->post('pemilik_atau_pengelola_usaha_pariwisata', 'Riset4::pemilik_atau_pengelola_usaha_pariwisata'); // Menu 2 Submenu 1
        $routes->post('unit_usaha_pariwisata', 'Riset4::unit_usaha_pariwisata'); // Menu 2 Submenu 2
        $routes->post('pemanfaatan_tik', 'Riset4::pemanfaatan_tik'); // Menu 2 Submenu 3

        // Menu 3
        $routes->get('karakteristik_kesiapan_uup', 'Riset4::karakteristik_kesiapan_uup'); // Menu 3

        $routes->post('karakteristik_kesiapan_uup', 'Riset4::karakteristik_kesiapan_uup'); // Menu 3
        ...
        $routes->post('deskripsi_singkat', 'Riset4::deskripsi_singkat'); // Menu 4 Submenu 1
        $routes->post('dimensi', 'Riset4::dimensi'); // Menu 4 Submenu 2
        $routes->post('kecamatan', 'Riset4::kecamatan'); // Menu 4 Submenu 3
        $routes->post('jenis_unit_usaha', 'Riset4::jenis_unit_usaha'); // Menu 4 Submenu 4
